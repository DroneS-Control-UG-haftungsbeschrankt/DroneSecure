...
interface AppInfoDAO {
    ...
    @Query(
        "update AppInfo set firewallStatus = :firewallStatus, connectionStatus = :connectionStatus where uid = :uid and packageName != 'com.dronescontrol.dronesecure'"
    )
    ...
    @Query("update AppInfo set firewallStatus = 5, connectionStatus = 3 where packageName = 'com.dronescontrol.dronesecure'")
