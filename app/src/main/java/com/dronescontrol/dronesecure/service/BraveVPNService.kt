...
//import com.dronescontrol.dronesecure.rpnproxy.RpnProxyManager.RpnMode
//import com.dronescontrol.dronesecure.rpnproxy.RpnProxyManager.rpnMode
import Logger
...
import com.dronescontrol.dronesecure.RethinkDnsApplication.Companion.DEBUG
import com.dronescontrol.dronesecure.customdownloader.IpInfoDownloader
import com.dronescontrol.dronesecure.data.AppConfig
import com.dronescontrol.dronesecure.data.ConnTrackerMetaData
import com.dronescontrol.dronesecure.data.ConnectionSummary
import com.dronescontrol.dronesecure.database.AppInfo
import com.dronescontrol.dronesecure.database.ConnectionTracker
import com.dronescontrol.dronesecure.database.ConnectionTrackerRepository
import com.dronescontrol.dronesecure.database.ConsoleLog
import com.dronescontrol.dronesecure.database.RefreshDatabase
import com.dronescontrol.dronesecure.net.go.GoVpnAdapter
import com.dronescontrol.dronesecure.net.manager.ConnectionTracer
import com.dronescontrol.dronesecure.receiver.NotificationActionReceiver
import com.dronescontrol.dronesecure.receiver.UserPresentReceiver
import com.dronescontrol.dronesecure.scheduler.EnhancedBugReport
import com.dronescontrol.dronesecure.service.FirewallManager.NOTIF_CHANNEL_ID_FIREWALL_ALERTS
import com.dronescontrol.dronesecure.service.ProxyManager.ID_WG_BASE
import com.dronescontrol.dronesecure.service.ProxyManager.isNotLocalAndRpnProxy
import com.dronescontrol.dronesecure.ui.NotificationHandlerActivity
import com.dronescontrol.dronesecure.ui.activity.AppLockActivity
import com.dronescontrol.dronesecure.ui.activity.MiscSettingsActivity
import com.dronescontrol.dronesecure.util.AndroidUidConfig
import com.dronescontrol.dronesecure.util.BackgroundAccessibilityService
import com.dronescontrol.dronesecure.util.CoFactory
import com.dronescontrol.dronesecure.util.ConnectivityCheckHelper
import com.dronescontrol.dronesecure.util.Constants
import com.dronescontrol.dronesecure.util.Constants.Companion.INIT_TIME_MS
import com.dronescontrol.dronesecure.util.Constants.Companion.INVALID_UID
import com.dronescontrol.dronesecure.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_NAME
import com.dronescontrol.dronesecure.util.Constants.Companion.NOTIF_INTENT_EXTRA_ACCESSIBILITY_VALUE
import com.dronescontrol.dronesecure.util.Constants.Companion.PRIMARY_USER
import com.dronescontrol.dronesecure.util.Constants.Companion.UID_EVERYBODY
import com.dronescontrol.dronesecure.util.CrashReporter
import com.dronescontrol.dronesecure.util.Daemons
import com.dronescontrol.dronesecure.util.FirebaseErrorReporting
import com.dronescontrol.dronesecure.util.IPUtil
import com.dronescontrol.dronesecure.util.InternetProtocol
import com.dronescontrol.dronesecure.util.KnownPorts
import com.dronescontrol.dronesecure.util.NotificationActionType
import com.dronescontrol.dronesecure.util.OrbotHelper
import com.dronescontrol.dronesecure.util.Protocol
import com.dronescontrol.dronesecure.util.UIUtils.getAccentColor
import com.dronescontrol.dronesecure.util.Utilities
import com.dronescontrol.dronesecure.util.Utilities.isAtleastO
import com.dronescontrol.dronesecure.util.Utilities.isAtleastQ
import com.dronescontrol.dronesecure.util.Utilities.isAtleastS
import com.dronescontrol.dronesecure.util.Utilities.isAtleastU
import com.dronescontrol.dronesecure.util.Utilities.isFdroidFlavour
import com.dronescontrol.dronesecure.util.Utilities.isMissingOrInvalidUid
import com.dronescontrol.dronesecure.util.Utilities.isNetworkSame
import com.dronescontrol.dronesecure.util.Utilities.isPlayStoreFlavour
import com.dronescontrol.dronesecure.util.Utilities.isUnspecifiedIp
import com.dronescontrol.dronesecure.util.Utilities.showToastUiCentered
import com.dronescontrol.dronesecure.util.Utilities.tos
