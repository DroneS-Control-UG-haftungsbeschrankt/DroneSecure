...
class FirewallRulesetTest {
    ...
    fun testRuleActions() {
        ...
        assertEquals(com.dronescontrol.dronesecure.R.integer.block, FirewallRuleset.RULE1B.act)
        
        // RULE8 should be an allow rule
        assertEquals(com.dronescontrol.dronesecure.R.integer.allow, FirewallRuleset.RULE8.act)
