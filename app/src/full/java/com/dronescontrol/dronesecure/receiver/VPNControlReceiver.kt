...
package com.dronescontrol.dronesecure.receiver
...
class VpnControlReceiver: BroadcastReceiver(), KoinComponent {
    ...
    companion object {
        ...
        private const val ACTION_START = "com.dronescontrol.dronesecure.intent.action.VPN_START"
        private const val ACTION_STOP = "com.dronescontrol.dronesecure.intent.action.VPN_STOP"
