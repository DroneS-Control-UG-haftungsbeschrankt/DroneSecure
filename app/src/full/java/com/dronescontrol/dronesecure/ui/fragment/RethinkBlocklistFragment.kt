...
import com.dronescontrol.dronesecure.adapter.LocalAdvancedViewAdapter
import com.dronescontrol.dronesecure.adapter.LocalSimpleViewAdapter
import com.dronescontrol.dronesecure.adapter.RemoteAdvancedViewAdapter
import com.dronescontrol.dronesecure.adapter.RemoteSimpleViewAdapter
import com.dronescontrol.dronesecure.customdownloader.LocalBlocklistCoordinator.Companion.CUSTOM_DOWNLOAD
import com.dronescontrol.dronesecure.data.AppConfig
import com.dronescontrol.dronesecure.data.FileTag
import com.dronescontrol.dronesecure.databinding.FragmentRethinkBlocklistBinding
import com.dronescontrol.dronesecure.download.AppDownloadManager
import com.dronescontrol.dronesecure.download.DownloadConstants.Companion.DOWNLOAD_TAG
import com.dronescontrol.dronesecure.download.DownloadConstants.Companion.FILE_TAG
import com.dronescontrol.dronesecure.service.PersistentState
import com.dronescontrol.dronesecure.service.RethinkBlocklistManager
import com.dronescontrol.dronesecure.service.RethinkBlocklistManager.RethinkBlocklistType.Companion.getType
import com.dronescontrol.dronesecure.service.RethinkBlocklistManager.getStamp
import com.dronescontrol.dronesecure.service.RethinkBlocklistManager.getTagsFromStamp
import com.dronescontrol.dronesecure.service.VpnController
import com.dronescontrol.dronesecure.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_NAME
import com.dronescontrol.dronesecure.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_TYPE
import com.dronescontrol.dronesecure.ui.activity.ConfigureRethinkBasicActivity.Companion.RETHINK_BLOCKLIST_URL
import com.dronescontrol.dronesecure.ui.bottomsheet.RethinkPlusFilterBottomSheet
import com.dronescontrol.dronesecure.util.Constants
import com.dronescontrol.dronesecure.util.Constants.Companion.DEAD_PACK
import com.dronescontrol.dronesecure.util.Constants.Companion.DEFAULT_RDNS_REMOTE_DNS_NAMES
import com.dronescontrol.dronesecure.util.Constants.Companion.MAX_ENDPOINT
import com.dronescontrol.dronesecure.util.Constants.Companion.RETHINK_STAMP_VERSION
import com.dronescontrol.dronesecure.util.CustomLinearLayoutManager
import com.dronescontrol.dronesecure.util.UIUtils
import com.dronescontrol.dronesecure.util.UIUtils.fetchToggleBtnColors
import com.dronescontrol.dronesecure.util.UIUtils.htmlToSpannedText
import com.dronescontrol.dronesecure.util.Utilities.getRemoteBlocklistStamp
import com.dronescontrol.dronesecure.util.Utilities.hasLocalBlocklists
import com.dronescontrol.dronesecure.util.Utilities.hasRemoteBlocklists
import com.dronescontrol.dronesecure.util.Utilities.showToastUiCentered
import com.dronescontrol.dronesecure.viewmodel.LocalBlocklistPacksMapViewModel
import com.dronescontrol.dronesecure.viewmodel.RemoteBlocklistPacksMapViewModel
import com.dronescontrol.dronesecure.viewmodel.RethinkLocalFileTagViewModel
import com.dronescontrol.dronesecure.viewmodel.RethinkRemoteFileTagViewModel
